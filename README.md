...
Учебный backend-проект на Spring Boot: REST API для управления пользователями и адресами.

Проект сделан как backend pet-project с базовыми практиками, которые используются в реальной разработке:
